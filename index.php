...
<body>
  ...
  <nav>
    <!--equipment, musica, home, brands, instrumentos  -->
  ...
  <div id="shopping_Cart">
    <span style="font-size:18px; padding: 5px; line-height:40px;">
      ...
      Cantidad de Items: <?php if (isset($_SESSION['customer_email'])) {
                            total_items();
                          } else {
                            echo "Login para ver";
                          } ?>
  ...
  <script type="text/javascript" src="js/sliderHead.js"></script>
</body>
